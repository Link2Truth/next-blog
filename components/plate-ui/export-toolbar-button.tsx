  ...
  return (
    <DropdownMenu modal={false} {...openState} {...props}>
      ...
      <DropdownMenuContent align="start">
        <DropdownMenuGroup>
          <DropdownMenuItem onSelect={exportToHtml}>HTML</DropdownMenuItem>
          <DropdownMenuItem onSelect={exportToPdf}>PDF</DropdownMenuItem>
          <DropdownMenuItem onSelect={exportToImage}>Image</DropdownMenuItem>
